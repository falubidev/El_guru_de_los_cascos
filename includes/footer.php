<footer id="footer" class="footer accent-background">
  <div class="container text-center">
    <div class="copyright">
      <p>© Copyright <strong class="px-1 sitename">El Gurú de los Cascos</strong> Todos los derechos reservados</p>
    </div>
    ...
    <div class="by-falubi">
      <p class="mb-0" style="font-size: 0.9rem;">
        Desarrollado por <a href="https://missatest.com" target="_blank" style="color: #39ff14; text-decoration: underline;">Falubi</a>
      </p>
    </div>
  </div>
</footer>
